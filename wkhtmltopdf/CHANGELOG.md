## 0.3.0
* Enhancement: Updated to wkhtmltopdf 0.12.1
* Enhancement: Added source recipe to install from source
* Enhancement: Setup test-kitchen and serverspec for integration tests
